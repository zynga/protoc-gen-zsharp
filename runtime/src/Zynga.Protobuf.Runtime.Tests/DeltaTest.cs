...
namespace Com.Zynga.Runtime.Protobuf {
  ...
  /// <summary>Holder for reflection information generated from delta_test.proto</summary>
  public static partial class DeltaTestReflection {

    #region Descriptor
    /// <summary>File descriptor for delta_test.proto</summary>
    ...
    static DeltaTestReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChBkZWx0YV90ZXN0LnByb3RvEhpjb20uenluZ2EucnVudGltZS5wcm90b2J1",
            "ZhoSZXZlbnRfcGx1Z2luLnByb3RvGh9nb29nbGUvcHJvdG9idWYvdGltZXN0",
            "YW1wLnByb3RvGh5nb29nbGUvcHJvdG9idWYvZHVyYXRpb24ucHJvdG8izAcK",
            "CFRlc3RCbG9iEjEKA2JhchgBIAEoCzIfLmNvbS56eW5nYS5ydW50aW1lLnBy",
            "b3RvYnVmLkJhclIDYmFyEjEKA2ZvbxgCIAEoCzIfLmNvbS56eW5nYS5ydW50",
            "aW1lLnByb3RvYnVmLkZvb1IDZm9vElkKDWludF90b19zdHJpbmcYAyADKAsy",
            "NS5jb20uenluZ2EucnVudGltZS5wcm90b2J1Zi5UZXN0QmxvYi5JbnRUb1N0",
            "cmluZ0VudHJ5UgtpbnRUb1N0cmluZxJZCg1zdHJpbmdfdG9fZm9vGAQgAygL",
            "MjUuY29tLnp5bmdhLnJ1bnRpbWUucHJvdG9idWYuVGVzdEJsb2IuU3RyaW5n",
            "VG9Gb29FbnRyeVILc3RyaW5nVG9Gb28SFAoFaWxpc3QYBSADKAVSBWlsaXN0",
            "EhQKBXNsaXN0GAYgAygJUgVzbGlzdBI5Cgdmb29saXN0GAcgAygLMh8uY29t",
            "Lnp5bmdhLnJ1bnRpbWUucHJvdG9idWYuRm9vUgdmb29saXN0Ej0KCG1heWJl",
            "Zm9vGAggASgLMh8uY29tLnp5bmdhLnJ1bnRpbWUucHJvdG9idWYuRm9vSABS",
            "CG1heWJlZm9vEhwKCG1heWJlaW50GAkgASgFSABSCG1heWJlaW50EiIKC21h",
            "eWJlc3RyaW5nGAogASgJSABSC21heWJlc3RyaW5nEjUKA3phbRgLIAEoCzIj",
            "LmNvbS56eW5nYS5ydW50aW1lLnByb3RvYnVmLkZvby5aYW1SA3phbRIdCgpm",
            "aWVsZF9ib29sGAwgASgIUglmaWVsZEJvb2wSOAoJdGltZXN0YW1wGA0gASgL",
            "MhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIJdGltZXN0YW1wEjUKCGR1",
            "cmF0aW9uGA4gASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uUghkdXJh",
            "dGlvbhJGCglhbGxfcHJpbXMYDyABKAsyKS5jb20uenluZ2EucnVudGltZS5w",
            "cm90b2J1Zi5BbGxQcmltaXRpdmVzUghhbGxQcmltcxo+ChBJbnRUb1N0cmlu",
            "Z0VudHJ5EhAKA2tleRgBIAEoBVIDa2V5EhQKBXZhbHVlGAIgASgJUgV2YWx1",
            "ZToCOAEaXwoQU3RyaW5nVG9Gb29FbnRyeRIQCgNrZXkYASABKAlSA2tleRI1",
            "CgV2YWx1ZRgCIAEoCzIfLmNvbS56eW5nYS5ydW50aW1lLnByb3RvYnVmLkZv",
            "b1IFdmFsdWU6AjgBOgTIuB4BQgYKBHRlc3QigAIKA0ZvbxISCgRsb25nGAEg",
            "ASgDUgRsb25nEhAKA3N0chgCIAEoCVIDc3RyEjEKA2ZvbxgDIAEoCzIfLmNv",
            "bS56eW5nYS5ydW50aW1lLnByb3RvYnVmLkZvb1IDZm9vEj0KB2VudW1lcm8Y",
            "BCABKA4yIy5jb20uenluZ2EucnVudGltZS5wcm90b2J1Zi5FbnVtZXJvUgdl",
            "bnVtZXJvEjYKBG9rYXkYBSABKA4yIi5jb20uenluZ2EucnVudGltZS5wcm90",
            "b2J1Zi5Gb28ub2tSBG9rYXkaFQoDWmFtEg4KAmhpGAEgASgFUgJoaSIMCgJv",
            "axIGCgJISRAAOgTIuB4BIj4KA0JhchIxCgNmb28YASABKAsyHy5jb20uenlu",
            "Z2EucnVudGltZS5wcm90b2J1Zi5Gb29SA2ZvbzoEyLgeASLnAQoNQWxsUHJp",
            "bWl0aXZlcxIMCgFhGAEgASgNUgFhEgwKAWIYAiABKAVSAWISDAoBYxgDIAEo",
            "BlIBYxIMCgFkGAQgASgHUgFkEgwKAWUYBSABKBBSAWUSDAoBZhgGIAEoD1IB",
            "ZhIMCgFnGAcgASgBUgFnEgwKAWgYCCABKAJSAWgSDAoBaRgJIAEoCFIBaRIM",
            "CgFqGAogASgJUgFqEgwKAWsYCyABKAxSAWsSDAoBbBgMIAEoA1IBbBIMCgFt",
            "GA0gASgEUgFtEgwKAW4YDiABKBFSAW4SDAoBbxgPIAEoElIBbzoEyLgeASot",
  ...
  public sealed partial class TestBlob : zpr::EventRegistry, pb::IMessage<TestBlob> {
    ...
    private readonly pbc::MapField<int, string> intToString_ = new pbc::MapField<int, string>();
    public void AddIntToString(int key, string value) {
    ...
    public void ClearIntToString() {
     AddEvent(3, zpr.EventSource.EventAction.ClearMap, -1);
     intToString_.Clear();
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    #if !NET35
    public IReadOnlyDictionary<int, string> IntToString {
    ...
    private readonly pbc::MapField<string, global::Com.Zynga.Runtime.Protobuf.Foo> stringToFoo_ = new pbc::MapField<string, global::Com.Zynga.Runtime.Protobuf.Foo>();
    public void AddStringToFoo(string key, global::Com.Zynga.Runtime.Protobuf.Foo value) {
     var mapEvent = new zpr.EventSource.EventMap();
     using (var memStream = new MemoryStream()) {;
       var dataStream = new CodedOutputStream(memStream);
    ...
    public void ClearStringToFoo() {
     AddEvent(4, zpr.EventSource.EventAction.ClearMap, -1);
     stringToFoo_.Clear();
    }
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    #if !NET35
    public IReadOnlyDictionary<string, global::Com.Zynga.Runtime.Protobuf.Foo> StringToFoo {
